...
const Panel = ({ panelNumber }) => {
    ...
    const image = useMemo(() => <div className={styles.loader}><img alt="try" ref={inputRef} className={styles.img} /></div>, []);
    const loading = useMemo(() => <div className={styles.loader}><Loader /></div>, []);
    ...
    }, [isLoading, isError, data, image, inputText, loading])
